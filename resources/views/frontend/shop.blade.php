...
<section class="middle">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-12 p-xl-0 d-none d-sm-block">
                    ...
                    <div class="search-sidebar-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group px-3">
                                <a href="{{ route('shop') }}" class="btn form-control">Reset Filter</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="border mb-3 mfliud">
                            <div class="row align-items-center py-2 m-0">
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5">
                                    <h6 class="mb-0">Products Found:{{ $products_count }}</h6>
                                </div>
