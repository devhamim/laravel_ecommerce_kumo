...
<section class="p-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 d-none d-sm-block">
                                ...
                                <div class="col-md-12">
                                    <div class="home-slider-container">
                                        ...
                                        <div class="home-slider-desc">
                                            ...
                                            <a href="{{ route('shop') }}" class="btn btn-white stretched-link hover-black">Buy Now<i class="lni lni-arrow-right ml-2"></i></a>
                                        </div>
                                        <!-- Slide Title / End -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12">
                <div class="tags_explore text-center">
                    ...
                    <a href="{{ route('shop') }}" class="btn btn-lg bg-white px-5 text-dark ft-medium">Explore Your Order</a>
                </p></div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ftr-content">
                    ...
                    <!-- Single Item -->
                    @foreach ($recent_view_product->take(3) as $key=>$recent)
