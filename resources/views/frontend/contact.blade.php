        ...
        <div class="row align-items-start justify-content-between">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="card-wrap-body mb-4">
                    ...
                    <p>House # 85/2, Road # 4, Mohommadia Housing ltd, Mohommadpur Dhaka-1207</p>
                    <p class="lh-1"><span class="text-dark ft-medium">Email:</span>nugortech@gmail.com</p>
                </div>

                <div class="card-wrap-body mb-3">
                    <h4 class="ft-medium mb-3 theme-cl">Make a Call</h4>
                    <h6 class="ft-medium mb-1">Customer Care:</h6>
                    <p class="mb-2">01303-523442</p>
                ...
                <div class="card-wrap-body mb-3">
                    ...
                    <p class="lh-1 text-dark">nugortech@gmail.com</p>
                    <p class="lh-1 text-dark">Sells@nugortech.com</p>
                </div>
            </div>
